...
// Methoden zum Traversieren
	...
	private String traversierePreOrder(final Knoten<T> einKnoten)
	{
		...
		String sTrav="";
		//Daten verarbeitung
		sTrav = sTrav+" - "+einKnoten.getDaten();
		//Linker Aufruf
		if(einKnoten.getKnotenLinks()!=null) {
			sTrav= sTrav+traversierePreOrder(einKnoten.getKnotenLinks());
		}
		//Rechter Aufruf
		if(einKnoten.getKnotenRechts()!=null){
			sTrav= sTrav+traversierePreOrder(einKnoten.getKnotenRechts());
		}
		return sTrav;
	}
	...
	private String traversiereInOrder(final Knoten<T> einKnoten)
	{
		...
		//Linker Aufruf
		if(einKnoten.getKnotenLinks()!=null) {
			sTrav= sTrav+traversiereInOrder(einKnoten.getKnotenLinks());
		}
		//Datenverarbeitung
		sTrav = sTrav+" - "+einKnoten.getDaten();
		...
		//Rechter aufruf
		if(einKnoten.getKnotenRechts()!=null){
			sTrav= sTrav+traversiereInOrder(einKnoten.getKnotenRechts());
		}
		return sTrav;
	}
	...
	private String traversierePostOrder(final Knoten<T> einKnoten)
	{
		...
		//Linker Aufruf
		if(einKnoten.getKnotenLinks()!=null) {
			sTrav= sTrav+traversierePostOrder(einKnoten.getKnotenLinks());
		}

		//Rechter aufruf
		if(einKnoten.getKnotenRechts()!=null){
			sTrav= sTrav+traversierePostOrder(einKnoten.getKnotenRechts());
		}
